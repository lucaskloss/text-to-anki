...
class ItalianProcessor():
    """
    Processes Italian text using spaCy for tokenization, lemmatization, and POS tagging.
    ...
    def __init__(self, nlp=None):
        ...
        """
        self.nlp = nlp or spacy.load("it_core_news_md")
        self.vocabulary = {}

    def process(self, text: str):
        """
        Processes Italian text for vocabulary extraction.
        """
        doc = self.nlp(text)
