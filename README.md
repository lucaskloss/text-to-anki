...
Note: Tested with Python 3.11.14, might not work with more recent python versions because of compatibility issues with spacy. To install a specific version of Python, you can use a version manager like `pyenv`. Here’s how you can install Python 3.11.14 using `pyenv`:
...
2. Install Python 3.11.14 using `pyenv`:
```bash
